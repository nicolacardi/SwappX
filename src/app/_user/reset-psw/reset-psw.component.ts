...
//#endregion
  ...
  async onSubmit(){
    ...
    "<br><br> Puoi accedere tramite questo <a href='localhost:4200/change-psw-ext?username="+user.userName+"&key=" + rndPassword +"'>link<a> e cambiare la password temporanea "+
